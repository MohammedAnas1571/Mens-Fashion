...
const {loadAaminLogin,calculateReport,loadSales,addEditCoupon,loadCouponEdit,deleteCoupon,activeCoupon,loadCoupon,addCoupon,couponManagement,adminlogin,dashboard,UnblockTheUser,blockTheUser,addProductCategory,loadCategory,loadAddCategory,deleteCategory,loadProductCreate, createProduct,loadProductPage,loadProductEditPage,editProduct,productActivate,productDeactivate,deleteImgDelete,orderManagment,updateStatus } = require("../controller/adminControler")
...
router.post("/adminsign",isAdmin,adminlogin)
...
router.post("/addcatagory",adminAuth,upload.single('image'),imageCrop,addProductCategory)
router.get("/Category-management",adminAuth,loadCategory)
router.post("/admin/productdetails/editProduct",adminAuth,)
router.get("/Catagory/:id/Delete",adminAuth,deleteCategory)
router.get("/addproduct",adminAuth,loadProductCreate)
router.post("/addproduct",adminAuth,upload.array("images",5),multiCrop, createProduct )
router.get("/productlist",adminAuth,loadProductPage)
router.post("/productlist/Edit",adminAuth,upload.array("images",5),multiCrop,editProduct)
...
router.post("/addcoupon", adminAuth, couponManagement);
